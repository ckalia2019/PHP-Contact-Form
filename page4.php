...
// Store data from page 1 in session, grabbed from page 3
if ( ! empty( $_POST ) ) {
  $_SESSION['address'] = $_POST['address'];
  $_SESSION['city'] = $_POST['city'];
  $_SESSION['state'] = $_POST['state'];

  $insert_id = insert($_SESSION); //passing in our session array into our insert function to be stored in our database
}
